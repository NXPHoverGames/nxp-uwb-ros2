...
ARGUMENTS = [
    ...
    DeclareLaunchArgument('device_mac', default_value='[0x2222]',
                          description='Mac address of the two-ray ranging responder'),
    DeclareLaunchArgument('dst_mac', default_value='[0x1111]',
                          description='Mac address of the two-ray ranging initiator to respond to'),
]
